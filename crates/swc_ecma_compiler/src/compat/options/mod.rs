...
///
/// Transform options for the compat compiler.
///
/// This is a simplified version of the oxc TransformOptions that works with
/// SWC's infrastructure. Some features like advanced target resolution are
/// stubs in this version.

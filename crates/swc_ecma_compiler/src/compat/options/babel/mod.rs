...
use crate::compat::CompilerAssumptions;
...
/// Operating system options for Babel tests
...
impl BabelOptions {
    ...
    /// # Panics
    ///
    /// Panics if options.json cannot be read or parsed.
    ...
    /// Check if source type is unambiguous

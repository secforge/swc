...
use crate::compat::jsx::{JsxOptions, JsxRuntime};
...
pub fn update_options_with_comments(comments: &[String], jsx: &mut JsxOptions) {
    for comment in comments {
        update_options_with_comment(jsx, comment);
    }
}

fn update_options_with_comment(jsx: &mut JsxOptions, comment: &str) {
